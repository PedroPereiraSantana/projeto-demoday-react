...
import SelecionarAvatar from "../SelecionarAvatar/SelecionarAvatar.jsx";
...
export default function BannerPerfil({ bannerUrl, isOwner, nome }) {
  ...
  const menuClasse = `${styles.menuOpcoes} ${
    theme === "dark" ? styles.menuOpcoesDark : ""
  }`;
