...
export default function RecompensasPage() {
  ...
  const missoes = [
    {
      id: 1,
      titulo: "Participe de três torneios",
      progresso: 3,
      meta: 3,
      tipo: "Diária",
      recompensa: "100xp",
    ...
    {
      id: 2,
      titulo: "Enfrente 5 jogadores diferentes em um único torneio",
      progresso: 0,
      meta: 5,
      tipo: "Secundária",
      recompensa: "200xp",
    ...
    {
      id: 3,
      titulo: "Vença 3 partidas seguidas em torneios",
      progresso: 0,
      meta: 3,
      tipo: "Secundária",
      recompensa: "150xp",
        ...
        <section className={styles.container}>
          ...
          <div className={styles.recompensasHeader}>
            <p className={styles.subtitulo}>
              Participe de torneios e conclua missões para ganhar pontos.
            </p>
            <button onClick={handleResgatarTudo} className={styles.btnResgatar}>
              Resgatar Tudo
            </button>
          </div>
          ...
          <div className={styles.nivelContainer}>
            <div>
              <p className={styles.nivelLabel}>
                Nível Atual: <strong>{nivel}</strong>
              </p>
              <div className={styles.progressBarWrapper}>
                <div
                  className={styles.progressBar}
                  style={{ width: `${(pontos / 1500) * 100}%` }}
                ></div>
              </div>
            ...
            <div>
              <p className={styles.desbloqueioTitulo}>
                Desbloqueie no Nível 1:
              </p>
                ...
                .map((missao) => (
                  <div key={missao.id} className={styles.missaoCard}>
                    ...
                    <div className={styles.progressMiniWrapper}>
                      <div
                        className={styles.progressMini}
                        style={{
                          width: `${(missao.progresso / missao.meta) * 20}%`,
                        }}
                      ></div>
                    </div>
