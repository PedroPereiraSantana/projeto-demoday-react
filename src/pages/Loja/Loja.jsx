...
const produtosExemplos = [
  {
    id: 1,
    nome: "Camiseta Rivalix",
    preco: 60.0,
    imagem: camisetaRivalix,
    categoria: ["Roupas", "Kit Rivalix"],
  },
  {
    id: 2,
    nome: "HeadSeat",
...
export default function Loja() {
  ...
  return (
    <>
      <NavbarHome />
      {carregamentoVisivel && (
        <Carregamento mensagem="Compra finalizada com sucesso!" />
      )}
          ...
          <div className={styles.headerTop}>
            <div>
              ...
              <p className={styles.subtitulo}>
                Equipe-se para vencer. Explore itens exclusivos e leve seu jogo
                ao próximo nível.
              </p>
            </div>
          ...
          <div className={styles.categorias}>
            <div
              className={`${styles.categoria} ${
                categoriaAtiva === "Todos" ? styles.ativa : ""
              }`}
            ...
            {categorias.map((item, i) => (
              <div
                key={i}
                className={`${styles.categoria} ${
                  categoriaAtiva === item.nome ? styles.ativa : ""
                }`}
